...
* Абстрактные классы - похожи на интерфейсы, можно объявлять абстрактые методы, которые будут аналогом методов 
* в интерфейсах, т.е. у них не будет реализации, но в них можно создавать и обычные методы с реализацией и какой-то
* логикой. Класс, который унаследуется от абстрактного унаследует все обычные методы и так же должен будет 
* реализовывать методы абстрактные, т.е. в них дожна быть какая-то логика
* */
